...
import com.gersen.pontointeligente.api.dtos.FuncionarioDto;
...
public class FuncionarioController {
	 ...
	 */
	@PutMapping(value = "/{id}") // Put porque vai fazer atualização
	public ResponseEntity<Response<FuncionarioDto>> atualizar(@PathVariable("id") Long id,
		...
		// quando tem o optional, a forma de recuperar o dado do optional é usando o get
		...
		// como funcionário é um optional é preciso um get para instanciar o funcionário
		response.setData(this.converterFuncionarioDto(funcionario.get()));
		// convertefuncionáriodto é passar para dto para poder exibir para o cliente.
		// tudo menos a senha, é claro
	...
	private void atualizarDadosFuncionario(Funcionario funcionario, FuncionarioDto funcionarioDto, BindingResult result)
		...
		if (!funcionario.getEmail().equals(funcionarioDto.getEmail())) {
			// verifica primeiro se esse novo email já não existe na base de dados
