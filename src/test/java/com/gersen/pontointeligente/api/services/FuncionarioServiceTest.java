...
import com.gersen.pontointeligente.api.repositories.FuncionarioRepository;
...
public class FuncionarioServiceTest {
	...
	// aqui não é necessário testar o repositório, ele é testado em outra classe, só vamos simular sua chamada.

	@Autowired
	private FuncionarioService funcionarioService;

//	Spring boot anterior a versao 2,0
//	@Before
...
//	Spring versao 2.0
	...
	public void testPersistirFuncionario() {
		...
		assertNotNull(funcionario); // para garantir que retornou
	}
