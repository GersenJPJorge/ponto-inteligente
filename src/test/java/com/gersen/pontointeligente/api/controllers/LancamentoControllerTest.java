...
public class LancamentoControllerTest {
	...
	public void testCadastrarLancamento() throws Exception {
		...
		mvc.perform(MockMvcRequestBuilders.post(URL_BASE)
				.content(this.obterJsonRequisicaoPost()) // forma json de fazer um post passando uma requisição no corpo
	...
	public void testCadastrarLancamentoFuncionarioIdInvalido() throws Exception {
		...
		// simulando um retorno vazio - como se não encontrasse um funcionário
	...
	private String obterJsonRequisicaoPost() throws JsonProcessingException {
		...
		ObjectMapper mapper = new ObjectMapper(); // pega os valores acima e converte em objeto json
